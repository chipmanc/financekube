...
REFRESH_TOKEN = ('4V8OOtyfti71pRLMzTelZZqjvxLJMcw5pFO3Lv72OUuUwOqbHiWogg1ZNZY3N7Il0mkA1b'
                 'LbemJ5_gE52zJ42NqTyG7t8cz3t8gJhGaS4j_Rnl2UhxAbeR-MvEvxku3RXjO7NmTodgQ@')
    ...
    def put_screen(data):
        ...
        for item in data:
            ...
            if (item['strike_discount'] <= .92 and
                ...
                print(f'{symbol} - {date} - {strike_price} - {item["cagr"]}')
